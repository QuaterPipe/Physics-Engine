...
namespace physics
{
	...
	struct Dynamicbody : public CollisionObject
	{
		...
		public:
			...
			geometry::Vector drag = geometry::Vector(1, 1);
			...
			const PhysicsMaterial& p = PhysicsMaterial(), const f64& mass = 1, bool usesGravity = true,
			const geometry::Vector& drag = geometry::Vector(1, 1)) noexcept;
